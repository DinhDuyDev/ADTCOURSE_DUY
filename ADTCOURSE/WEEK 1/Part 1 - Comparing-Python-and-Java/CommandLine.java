 ...
 * java CommandLine somelines.txt
 * "somelines.txt" is a command line argument (an argument entered in terminal)
 ...
 * 
 * Once you've tried running this program, try modifying it so that if there
