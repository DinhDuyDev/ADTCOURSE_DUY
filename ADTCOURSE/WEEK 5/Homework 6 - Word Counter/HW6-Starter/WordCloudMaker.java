 ...
 * Modified by Anya Vostinar, 1 February 2024
 */
public class WordCloudMaker {


     // The colors used in the word cloud.
    ...
    // The HTML template for the word cloud
     ...
     * frequency (least frequent to most).
     *
     *
    ...
    private static String makeHTMLWord(WordCount wordCount, int maximumFrequency, int minimumFrequency) {
        ...
        wordString += wordCount.getWord() + ": " + wordCount.getCount() + "&nbsp</span>\n";
        return wordString;
    }
}
