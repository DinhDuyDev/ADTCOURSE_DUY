...
public class Node {
  ...
  */
  ...
  private static Node insertCenter(Node rt, Integer key) {
    Node n = insertHelp(rt.center, key);
    if (n == rt.center) {
        return rt;
    } else {
        return rt.add(n);
  ...
  private static Node insertRight(Node rt, Integer key) {
    Node n = insertHelp(rt.right, key);
    if (n == rt.right) {
        return rt;
    } else {
        return rt.add(n);
  ...
  */
  public static Node insertHelp(Node rt, Integer key) {
    ...
    if (key.compareTo(rt.lval) < 0) {
        return insertLeft(rt, key);
    }
    else if (rt.right == null || (key.compareTo(rt.lval) > 0 && key.compareTo(rt.rval) < 0)) {
 ...
 */
  ...
  */
  ...
  public static void main(String[] args) {
    ...
    testroot = insertHelp(testroot, 18);
    testroot = insertHelp(testroot, 32);
    testroot = insertHelp(testroot, 12);
    testroot = insertHelp(testroot, 23);
    testroot = insertHelp(testroot, 30);
    testroot = insertHelp(testroot, 48);
    testroot = insertHelp(testroot, 10);
    testroot = insertHelp(testroot, 15);
    testroot = insertHelp(testroot, 20);
    testroot = insertHelp(testroot, 21);
    testroot = insertHelp(testroot, 24);
    testroot = insertHelp(testroot, 31);
    testroot = insertHelp(testroot, 45);
    testroot = insertHelp(testroot, 47);
    testroot = insertHelp(testroot, 50);
    testroot = insertHelp(testroot, 52);
